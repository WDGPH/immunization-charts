...
\\begin{center}
{\\color{darkred}\\Large \\textbf{Bring this notice to your family doctor or healthcare provider}}
\\end{center}
...
\\begin{minipage}[c]{0.60\\textwidth}
  \\raggedleft \\huge \\textbf{Immunization Notice}
\\end{minipage}
...
\\begin{table}[h!]
    ...
    \\hline ",
      if(client$`Age 16+`) {"To:"} else {"To the parent/guardian of:"},
        "\\newline\\redact{\\textbf{", client$Name, "}}
        \\newline\\newline
        \\begin{minipage}[t]{\\linewidth}\\raggedright
            \\textbf{\\redact{", if(!is.na(client$`Street Address Line 1`)) {paste0(client$`Street Address Line 1`, collapse = "")}, "}",
            if(!is.na(client$`Street Address Line 2`)) {paste0("\\newline ", client$`Street Address Line 2`, collapse = "")},
    ...
    &
        ...
        School: \\begin{minipage}[t]{\\dimexpr\\linewidth-\\schooltextwidth}\\raggedright
            \\textbf{", client$`School`, "}
        \\end{minipage}\\newline
    \\\\
    \\hline
...
Our files show \\redact{\\textbf{", client$Name, "}} has not received the following immunization(s):

\\vspace{0.25cm}
\\begin{bolditemize}
\\setlength\\itemsep{-0.5em}
  \\item ", client$`Vaccines Due LaTeX`, "
\\end{bolditemize}
\\vspace{0.25cm}

\\normalsize\\raggedright
It is the responsibility of the ", if(client$`Age 16+`) {"student or their parent/guardian"} else {"parent/guardian of the student"}, " to update this immunization record by reporting the vaccines received to Public Health. For your reference, a record of all immunizations on file with Public Health for the student, excluding seasonal vaccinations against influenza and COVID-19, has been included below.

For information on immunization exemptions, please visit: \\myurl{https://wdgpublichealth.ca/your-kids/vaccination}.
